...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_3.setText(QCoreApplication.translate("Widget", u"Correo", None))
        self.work.setPlaceholderText(QCoreApplication.translate("Widget", u"Correo", None))
        ...
        self.group.setItemText(0, QCoreApplication.translate("Widget", u"Familia", None))
